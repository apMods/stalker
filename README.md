...
1. Сильное/среднее кровоточение и менее 50% здоровья: `аптечка, бинт` либо `армейская аптечка`.
2. Любое кровоточение и более 50% здоровья: `бинт, аптечка` либо `армейская аптечка`.
3. Сильное/среднее облучение и менее 50% здоровья: `аптечка, антирад, вода` либо `научная аптечка`.
4. Сильное/среднее облучение и более 50% здоровья: `антирад, аптечка, вода` либо `научная аптечка`.
5. Среднее/слабое облучение и более 75% здоровья: `водка, выдержка времени, аптечка` либо `антирад, аптечка, вода` либо `научная аптечка`.
6. Радиация: `антирад, выдержка времени, антирад, вода, аптечка` либо `научная аптечка, выдержка времени, научная аптечка`.
7. Химическая аномалия: `антидот, выдержка времени, аптечка`.
8. Химическая аномалия + радиация: `антидот, радиопротектор, вода, антирад, выдержка времени, антирад, вода, аптечка` либо `антидот, радиопротектор, вода, научная аптечка, выдержка времени, научная аптечка`.
